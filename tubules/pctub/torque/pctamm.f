...
C
	DOUBLE PRECISION AMMGEN
C
C	AMMGEN- AMMONIA GENERATION ALONG THE LENGTH OF THE TUBULE (MMOL/S)
C
C  SOLUTE INDEX:
C	1-	NA+
C	2-	K+
...
C
        ...
        DO 20 I=1,CHOP
	AMMGEN = AMMGEN +
     1     0.5*SM(I,1)*(FEKS(10,I,1)+FEKS(11,I,1)+
     1       FIKS(1,10,I,1)+FIKS(1,11,I,1)
     1   -(FEKM(10,I,1)+FEKM(11,I,1)+
     1       FIKM(1,10,I,1)+FIKM(1,11,I,1)))
     1    + 0.5*SM(I+1,1)*(FEKS(10,I+1,1)+FEKS(11,I+1,1)+
     1       FIKS(1,10,I+1,1)+FIKS(1,11,I+1,1)
     1   -(FEKM(10,I+1,1)+FEKM(11,I+1,1)+
     1       FIKM(1,10,I+1,1)+FIKM(1,11,I+1,1)))
   20   CONTINUE
        AMMGEN = AMMGEN*DX
C
C UNITS FOR QIAMM ARE PMOL/MIN/CM; UNITS FOR FKM ARE PMOL/MIN
  470   WRITE (15,480) 6.D10*SM(1,1)*QIAMM0, 1.D3*CS(11,CHOP+1,1),
     1     6.D10*FKM(11,1,1),6.D10*FKM(11,CHOP+1,1),6.D10*AMMGEN,
     1     1.D3*CM(11,CHOP+1,1)
  480   FORMAT (8E16.8)
C
	RETURN
	END
