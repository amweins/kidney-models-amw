...
C  NKCC COTRANSPORTER
	CIKM(1,1) = CIKM(1,1) + JNKCC(1,1)
	CIKM(1,2) = CIKM(1,2) + JNKCC(1,2)
	CIKM(1,3) = CIKM(1,3) + JNKCC(1,3)
	CIKM(1,11) = CIKM(1,11) + JNKCC(1,4)
C
C  KCC COTRANSPORTER
	CJK(1,2) = CJK(1,2) + JKCC(1,1)*(AIE(1)/(AIE(1)+AI0(1)))
	CJK(1,3) = CJK(1,3) + JKCC(1,2)*(AIE(1)/(AIE(1)+AI0(1)))
	CJK(1,11) = CJK(1,11) + JKCC(1,3)*(AIE(1)/(AIE(1)+AI0(1)))
C
	CIKS(1,2) = CIKS(1,2) + JKCC(1,1)*(AI0(1)/(AIE(1)+AI0(1)))
	CIKS(1,3) = CIKS(1,3) + JKCC(1,2)*(AI0(1)/(AIE(1)+AI0(1)))
	CIKS(1,11) = CIKS(1,11) + JKCC(1,3)*(AI0(1)/(AIE(1)+AI0(1)))
C
C  TSC COTRANSPORTER
...
C
  ...
  140   PJK(K,I)=PJK(K,I)+AIE(K)*ATIE(K,I)
C
C
	WRITE (21,480) (SOL(I),
