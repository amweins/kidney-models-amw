...
C     1    1.D6*(FEKM(1,T)+FIKM(1,1,T)), 1.D6*JNAKCL
	IF (II.EQ.1) WRITE (23,500) 
C     1    1.D3*CM(1),LCHI(1), 1.D3*CI(1,3,T), 
     1    1.D6*(PJK(1,11)+PIKS(1,11)),
     1    1.D6*(GJK(1,11)+GIKS(1,11)),
     1    1.D6*(JK(1,11,T) +FIKS(1,11,T)),
     1    1.D6*(CJK(1,4)+CIKS(1,4)),
     1    1.D6*(GJK(1,4)+GIKS(1,4)),
     1    1.D6*(JK(1,4,T) +FIKS(1,4,T)),1.D6*PIKM(1,12)
  500   FORMAT (8D16.8)
C
	FEVM(T)=FEVM(T)/SCALE
	FEVS(T)=FEVS(T)/SCALE
