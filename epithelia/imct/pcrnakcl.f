...
C VARIATION IN THE NAKCL COEFFICIENT
C
...
C
	pis(2,16)=float(ksets+idelta-1)*dlis
	pis(2,17)=float(ksets+idelta-1)*dlis
	pis(2,18)=2.*float(ksets+idelta-1)*dlis
	pis(2,19)=float(ksets+idelta-1)*dlis
	pis(2,20)=2.*float(ksets+idelta-1)*dlis
	pis(2,21)=4.*float(ksets+idelta-1)*dlis
C
