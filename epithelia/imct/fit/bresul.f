...
C
	...
	WRITE (21,414) (SOL(I),
     1  CM(I),CE(I,T),(CI(K,I,T),K=1,1),CS(I),I=6,SOLS-3)	
	WRITE (21,412) (SOL(I),
     1  CM(I),CE(I,T),(CI(K,I,T),K=1,1),CS(I),I=SOLS-2,SOLS-2)	
	WRITE (21,414) (SOL(I),
     1  CM(I),CE(I,T),(CI(K,I,T),K=1,1),CS(I),I=SOLS-1,SOLS-1)	
	WRITE (21,412) SOL(SOLS),
     1  CM(SOLS),CE(SOLS,T),(CI(K,SOLS,T),K=1,1),CS(SOLS)
