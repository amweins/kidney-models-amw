...
C
	WRITE (27,470) (FIVM(K,T),JV(K,T)+FIVS(K,T),K=1,2),
     1   FEVM(T),FEVS(T),FLUXV
	WRITE (27,475) (SOL(I),
     1  (FIKM(K,I,T),JK(K,I,T)+FIKS(K,I,T),K=1,2),
     1  FEKM(I,T),FEKS(I,T),FLUXS(I),I=1,SOLS)
C
  470   FORMAT(1H1,/,14X,'FIVMP',7X,'FIVSP',7X,
     1  'FIVMA',7X,'FIVSA',7X,
     1  'FEVM',8X,'FEVS',8X,'FLUXV',/,9X,7D12.4)
  475   FORMAT(//,14X,'FIKMP',7X,'FIKSP',7X,
     1  'FIKMA',7X,'FIKSA',7X,
     1  'FEKM',8X,'FEKS',8X,'FLUXS',/,(4X,A5,7D12.4))
C
C
...
C
	...
	WRITE (27,495) (SOL(I),
     1  (GIKM(K,I),GJK(K,I)+GIKS(K,I),K=1,2),I=1,SOLS)
C
