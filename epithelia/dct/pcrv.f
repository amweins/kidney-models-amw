...
C
	ntsc(2) = float(ksets)*dntsc
	np(2) = basenp + float(ksets)*dnp
	pis(2,4) = basekc + float(ksets)*dpis
	pis(2,5) = basekc + float(ksets)*dpis
	pis(2,6) = basekc + float(ksets)*dpis
	nnhe3(2) = float(ksets)*dnhe
C
