...
C     1    FLUXS(1),FLUXS(2),FLUXS(12)-FLUXS(4)
	IF (II.EQ.1) WRITE (23,500) 1.D6*JTSC(1),
     1  1.D6*JNHE3(1,1),1.D6*JKCL,1.D6*(PJK(1,1)+PIKS(1,1)),
     1  1.D4*CLVL(1,T),1.D3*CI(1,1,T),1.D3*CI(1,3,T),1.D3*CI(1,4,T)
  500   FORMAT (8D16.8)
C
	FEVM(T)=FEVM(T)/SCALE
	FEVS(T)=FEVS(T)/SCALE
