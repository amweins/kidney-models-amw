...
C
	DOUBLE PRECISION 
     ...
     1    GIKM(3,12),GJK(3,12),GIKS(3,12),SS(4),VAE1
C
...
C
	WRITE (27,470) (FIVM(K,T),JV(K,T)+FIVS(K,T),K=2,2),
     1   FEVM(T),FEVS(T),FLUXV
	WRITE (27,475) (SOL(I),
     1  (FIKM(K,I,T),JK(K,I,T)+FIKS(K,I,T),K=2,2),
...
C
	...
	WRITE (27,495) (SOL(I),
     1  (GIKM(K,I),GJK(K,I)+GIKS(K,I),K=2,2),I=1,SOLS)
C
  480   FORMAT(/,14X,'CIKMA',7X,'CIKSA',7X,/,(4X,A5,2D12.4))
...
C
	IF (II.EQ.1) WRITE (23,570) 
     1   1.D6*FIKM(2,12,T),-1.D6*PIKM(2,2),
     1   1.D6*(FIKM(2,12,T)+PIKM(2,2)),
     1   1.D6*(CJK(2,4)+CIKS(2,4)),
     1   1.D6*(GJK(2,4)+GIKS(2,4)),
     1   1.D6*(CJK(2,12)+CIKS(2,12)),
     1   1.D6*(CJK(2,4)+CIKS(2,4))+
     1   1.D6*(GJK(2,4)+GIKS(2,4))-
     1   1.D6*(CJK(2,12)+CIKS(2,12))
  570   FORMAT(6E16.8)
