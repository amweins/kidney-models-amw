...
C
  ...
  335   FORMAT(9X,4F12.6)
	...
	READ(1,335) (RES(16,J),J=1,4)
	READ(1,330) (RES(17,J),J=1,4)
	READ(1,335) (RES(18,J),J=1,4)
	READ(1,340) RES(19,1),(RES(19,J),J=3,4)
  340   FORMAT(9X,F12.6,12X,2F12.6)
	READ(1,335) ((RES(I,J),J=1,4),I=20,21)
	READ(1,345) ((RES(I,J),J=3,3),I=22,23)
  345   FORMAT(33X,1F12.6)
	READ(1,350) ((RES(I,J),J=1,3),I=24,38)
  350   FORMAT(///,(9X,3F12.4))
	READ(1,355) (RES(39,J),J=1,3)
  355   FORMAT(///,9X,3D12.4)
	READ(1,360) ((RES(I,J),J=1,3),I=40,54)
  360   FORMAT(///,(9X,3D12.4))
	READ(1,365) (RES(55,J),J=1,3)
  365   FORMAT(9X,3D12.4)
	READ(1,370) RES(56,1),RES(56,2),(RES(56,J),J=4,5)
  370   FORMAT(///,9X,2D12.4,12X,2D12.4)
	READ(1,375) (RES(I,1),RES(I,2),(RES(I,J),J=4,5),I=57,71)
  375   FORMAT(///,(9X,2D12.4,12X,2D12.4))
	READ(1,380) (RES(72,J),J=1,2)
  380   FORMAT(9X,2D12.4)
	READ(1,385) ((RES(I,J),J=1,3),I=73,87)
  385   FORMAT(///,(9X,3D12.4))
	READ(1,390) ((RES(I,J),J=1,3),I=88,102)
...
C
  ...
  535   FORMAT(9X,4F12.6)
	...
	READ(1,535) (RES(16,J),J=1,4)
	READ(1,530) (RES(17,J),J=1,4)
	READ(1,535) (RES(18,J),J=1,4)
	READ(1,540) RES(19,1),(RES(19,J),J=3,4)
  540   FORMAT(9X,F12.6,12X,2F12.6)
	READ(1,535) ((RES(I,J),J=1,4),I=20,21)
	READ(1,545) ((RES(I,J),J=3,3),I=22,23)
  545   FORMAT(33X,1F12.6)
	READ(1,550) ((RES(I,J),J=1,3),I=24,38)
  550   FORMAT(///,(9X,3F12.4))
	READ(1,555) (RES(39,J),J=1,3)
  555   FORMAT(///,9X,3D12.4)
	READ(1,560) ((RES(I,J),J=1,3),I=40,54)
  560   FORMAT(///,(9X,3D12.4))
	READ(1,565) (RES(55,J),J=1,3)
  565   FORMAT(9X,3D12.4)
	READ(1,570) RES(56,1),RES(56,2),(RES(56,J),J=4,5)
  570   FORMAT(///,9X,2D12.4,12X,2D12.4)
	READ(1,575) (RES(I,1),RES(I,2),(RES(I,J),J=4,5),I=57,71)
  575   FORMAT(///,(9X,2D12.4,12X,2D12.4))
	READ(1,580) (RES(72,J),J=1,2)
  580   FORMAT(9X,2D12.4)
	READ(1,585) ((RES(I,J),J=1,3),I=73,87)
  585   FORMAT(///,(9X,3D12.4))
	READ(1,590) ((RES(I,J),J=1,3),I=88,102)
