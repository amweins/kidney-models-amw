...
C	IF (II.EQ.1) WRITE (23,500) TIME,1.D3*CM(15),
C     1    VI(1,T),1.D4*CLVL(1,T),1.D3*CI(1,1,T),LCHI(1),1.D6*JNAB
	IF (II.EQ.1) WRITE (23,500) TIME,
     1    3.D6*JNAB,1.D6*JNHE3(1,1),2.D6*JNACLB,
     1    VI(1,T),1.D4*CLVL(1,T),1.D3*CI(1,1,T),LCHI(1),
     1    1.D3*(CI(1,4,T)+CI(1,7,T)+CBUF(1,T))
  500   FORMAT (8D16.8)
C
	FEVM(T)=FEVM(T)/SCALE
	FEVS(T)=FEVS(T)/SCALE
