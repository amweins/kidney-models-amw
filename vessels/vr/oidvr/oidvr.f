...
C
C
	OPEN (UNIT=22,FILE='oidbound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='oidresult.dat')
	OPEN (UNIT=20,FILE='oidparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='oidend.dat')
C
