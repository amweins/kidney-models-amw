...
C
C
	OPEN (UNIT=22,FILE='oiabound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='oiaresult.dat')
	OPEN (UNIT=20,FILE='oiaparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='oiaend.dat')
C
