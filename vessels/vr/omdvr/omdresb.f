...
C
C
	WRITE (203,460) (SOL(I),I=1,4),(SOL(I),I=7,9),
     1   SOL(11),SOL(13),SOL(15)
  460   FORMAT(1H1,//,5X,'DIST',6X,'FVC',4X,'FKC:',
     1  10(A5,6X),' FBC ',7X,'HCTC')
	DO 470 KX=1,CHOP+1
	DIST=CL*FLOAT(KX-1)/FLOAT(CHOP)
  470   WRITE (203,480) DIST, 1.D6*FVC(KX,T),
...
C
	WRITE (203,464) (SOL(I),I=1,4),(SOL(I),I=7,9),
     1   SOL(11),SOL(13),SOL(15)
...
C
	WRITE (203,462) (SOL(I),I=1,4),(SOL(I),I=7,9),
     1   SOL(11),SOL(13),SOL(15)
  462   FORMAT(//,5X,'DIST',6X,'FVCS',2X,'FKCS:',
     1  10(A5,6X),2X,'CUR')
	DO 472 KX=1,CHOP+1
	DIST=CL*FLOAT(KX-1)/FLOAT(CHOP)
  472   WRITE (203,482) DIST,1.D6*FVCS(KX,T),
