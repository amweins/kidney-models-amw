...
C
        ...
        RDPAGE(38,IX)=RFVC(IVR,ISEG,IX)/SCAL(3)
        ...
        RDPAGE(58,IX)=RCC(IVR,ISEG,16,IX)
        DO 202 ISOL=1,15
...
C
	...
	WRITE (JUNIT,965) 0, 1.D3*WRDL(9,1,KK),1
	WRITE (JUNIT,965) 0, 1.D3*WRDL(10,1,KK),2
        WRITE (JUNIT,965) 1, -1.D3*WRRES(9,1,KK),1
        WRITE (JUNIT,965) 1, -1.D3*WRRES(10,1,KK),2
        WRITE (JUNIT,965) 2, -1.D3*WRRES(10,2,KK),2
        WRITE (JUNIT,965) 3, -1.D3*WRRES(10,3,KK),2
        WRITE (JUNIT,965) 4, -1.D3*WRRES(9,2,KK),1
        WRITE (JUNIT,965) 4, -1.D3*WRRES(10,4,KK),2
        WRITE (JUNIT,965) 5, 1.D3*WREX(9,2,KK),1
        WRITE (JUNIT,965) 5, 1.D3*WREX(10,4,KK),2
C
        GO TO 970
	NBARS=4
	WRITE (JUNIT,965) NBARS
	WRITE (JUNIT,965) 0, 1.D3*WRDL(8,1,KK),3
        WRITE (JUNIT,965) 1, -1.D3*WRRES(8,1,KK),3
        WRITE (JUNIT,965) 2, -1.D3*WRRES(8,2,KK),3
	WRITE (JUNIT,965) 2, 1.D3*WREX(8,2,KK),3
...
C
  ...
  410   READ (1,420) DIST(KX),PC(KX),
     ...
     1   CC(11,KX),CC(13,KX),CC(15,KX),CC(16,KX),IMPC(KX)
  419   FORMAT (2/)
