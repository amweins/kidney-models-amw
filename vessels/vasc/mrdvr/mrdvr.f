...
C
C
	OPEN (UNIT=22,FILE='mrdbound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='mrdresult.dat')
	OPEN (UNIT=20,FILE='mrdparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='mrdend.dat')
C
