...
C
C
	OPEN (UNIT=22,FILE='mrabound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='mraresult.dat')
	OPEN (UNIT=20,FILE='mraparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='mraend.dat')
C
