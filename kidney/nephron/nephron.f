	SUBROUTINE NEPHRON(TGPHI,COUNT,IFL)
C
...
C 
	INTEGER SOLS,TAU,T,TLIM,NPAR,X,CHOP,COUNT,CHOPS(12)
C
...
C
C  THESE CHOPS SHOULD HAVE BEEN SPECIFIED IN A FILE, BUT THEY ARE LITTLE LIKELY TO CHANGE
        CHOPS(1) = 80
        CHOPS(2) = OMCHOP/2
        CHOPS(3) = OMCHOP/2
        CHOPS(4) = IMCHOP
