...
C
	DOUBLE PRECISION 
     1    PIKM(3,12,901),PJK(3,12,901),PIKS(3,12,901),
     1    CIKM(3,12,901),CJK(3,12,901),CIKS(3,12,901),
     1    GIKM(3,12,901),GJK(3,12,901),GIKS(3,12,901)
C
...
C
	CHARACTER*5 SOL(12)
C
	DOUBLE PRECISION FLUXV(901),FLUXS(12,901),SCALE
C
...
C
	DOUBLE PRECISION JNAHS(901),JCLB(901),JNAP(901),JNAB(901)
C
C
