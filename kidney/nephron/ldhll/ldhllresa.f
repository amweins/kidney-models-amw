...
C
C
	WRITE (101,372) RTE,F,PKC,PKP,PKN,KHY(5),KDHY(5)
	WRITE (101,374) AME,AI0(1)
C
...
C
  ...
  380   FORMAT (//)
C
	WRITE (101,381) PFME,(PFMI(K),K=1,1)
	WRITE (101,384)
	WRITE (101,385) (SOL(I),SME(I),(SMI(K,I),K=1,1),I=1,SOLS)
	WRITE (101,386)
	WRITE (101,385) (SOL(I),HAME(I),(HAMI(K,I),K=1,1),I=1,SOLS)
	WRITE (101,388)
	WRITE (101,385) (SOL(I),GME(I),(GMI(K,I),K=1,1),I=1,SOLS)
	WRITE (101,389) TGME,(TGMI(K),K=1,1)
	WRITE (101,390) 1./TGME,(1./TGMI(K),K=1,1)
C
