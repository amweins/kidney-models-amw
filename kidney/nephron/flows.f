	SUBROUTINE FLOWS(CHOPS,COUNT,IFL)
C
...
C
	INTEGER SOLS,TAU,T,TLIM,COUNT,EXP,NPAR,X,CHOP,IFL,CHOPS(12)
C
...
C       CHOPS-   CHOPS OF THE 12 TUBULE SEGMENTS: PCT, DCT, and CNT NEED TO BE
C               SPECIFIED; OTHERS ARE DERIVED FROM OMCHOP, IMCHOP, AND MRCHOP
...
C These boundary values are set in KBSET
	FVM(1,T)=RFVM(1,1,1,1)
	PM(1,T) = RPM(1,1,1,1)
	PS(1,T)=RPS(1,1,1,1)
	PS(CHOPS(1)+1,T)=RPS(1,1,1,1)
	IMPM(1,T)=RIMPM(1,1,1,1)
	IMPS(1,T)=RIMPS(1,1,1,1)
	IMPS(CHOPS(1)+1,T)=RIMPS(1,1,1,1)
	DO 56 ISOL=1,11
	CM(ISOL,1,T)=RCM(1,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(1,1,ISOL,1,1)
   56   CS(ISOL,CHOPS(1)+1,T)=RCS(1,1,ISOL,1,1)
	DO 57 ISOL=13,15
	CM(ISOL,1,T)=RCM(1,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(1,1,ISOL,1,1)
   57   CS(ISOL,CHOPS(1)+1,T)=RCS(1,1,ISOL,1,1)
C
        IF (IFL.EQ.0) THEN
	AFVM(1) = AFVM0(1)*FVM0(1)
	DFVM(1) = DFVM0(1)*FVM0(1)
	DO 211 IPUMP = 1,3
  211   BCO2(IPUMP) = RBCO2(INEPH,1,IPUMP)
...
C
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,2)
	DO 212 IPUMP = 1,3
  212   BCO2(IPUMP) = RBCO2(INEPH,2,IPUMP)
        ELSE
...
C
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,3)
	DO 213 IPUMP = 1,3
  213   BCO2(IPUMP) = RBCO2(INEPH,3,IPUMP)
        ELSE
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,6)
	DO 214 IPUMP = 1,3
  214   BCO2(IPUMP) = RBCO2(INEPH,6,IPUMP)
        ELSE
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,7)
	DO 215 IPUMP = 1,3
  215   BCO2(IPUMP) = RBCO2(INEPH,7,IPUMP)
        ELSE
...
C These boundary values are set in KBSET
	PS(1,T)=RPS(1,8,1,1)
	PS(CHOPS(8)+1,T)=RPS(1,8,1,1)
	IMPS(1,T)=RIMPS(1,8,1,1)
	IMPS(CHOPS(8)+1,T)=RIMPS(1,8,1,1)
	DO 106 ISOL=1,11
	CS(ISOL,1,T)=RCS(1,8,ISOL,1,1)
  106   CS(ISOL,CHOPS(8)+1,T)=RCS(1,8,ISOL,1,1)
	DO 216 IPUMP = 1,3
  216   BCO2(IPUMP) = RBCO2(INEPH,8,IPUMP)
        ELSE
...
C
	...
	SOLS=15
C These boundary values are set in KBSET.
	FVM(1,T)=RFVM(2,1,1,1)
	PM(1,T) = RPM(2,1,1,1)
	PS(1,T)=RPS(2,1,1,1)
	PS(CHOPS(1)+1,T)=RPS(2,1,1,1)
	IMPM(1,T)=RIMPM(2,1,1,1)
	IMPS(1,T)=RIMPS(2,1,1,1)
	IMPS(CHOPS(1)+1,T)=RIMPS(2,1,1,1)
	DO 116 ISOL=1,11
	CM(ISOL,1,T)=RCM(2,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(2,1,ISOL,1,1)
  116   CS(ISOL,CHOPS(1)+1,T)=RCS(2,1,ISOL,1,1)
	DO 117 ISOL=13,15
	CM(ISOL,1,T)=RCM(2,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(2,1,ISOL,1,1)
  117   CS(ISOL,CHOPS(1)+1,T)=RCS(2,1,ISOL,1,1)
C
        IF (IFL.EQ.0) THEN
	AFVM(2) = AFVM0(2)*FVM0(2)
	DFVM(2) = DFVM0(2)*FVM0(2)
	DO 221 IPUMP = 1,3
  221   BCO2(IPUMP) = RBCO2(INEPH,1,IPUMP)
        ELSE IF (IFL.EQ.2) THEN
        CALL ARCHIVE(1,INEPH,1)
        ENDIF
C
...
C
        ...
        CALL ARCHIVE(4,INEPH,2)
	DO 222 IPUMP = 1,3
  222   BCO2(IPUMP) = RBCO2(INEPH,2,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,2)
        ENDIF
C
...
C
	SOLS=15
        ...
        CALL ARCHIVE(4,INEPH,3)
	DO 223 IPUMP = 1,3
  223   BCO2(IPUMP) = RBCO2(INEPH,3,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,3)
        ENDIF
C
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,4)
	DO 224 IPUMP = 1,3
  224   BCO2(IPUMP) = RBCO2(INEPH,4,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,4)
        ENDIF
C
	SOLS=12
        CHOP=(INEPH-1)*(CHOPS(4)/5)
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CHOP=(INEPH-1)*(CHOPS(5)/5)
        CALL ARCHIVE(4,INEPH,5)
	DO 225 IPUMP = 1,3
  225   BCO2(IPUMP) = RBCO2(INEPH,5,IPUMP)
        ELSE
...
C
	SOLS=15
        ...
        CALL ARCHIVE(3,1,6)
	DO 226 IPUMP = 1,3
  226   BCO2(IPUMP) = RBCO2(INEPH,6,IPUMP)
        MUM=RMUM(INEPH,5)
        CALL ARCHIVE(4,INEPH,6)
        ELSE
        CALL ARCHIVE(3,INEPH,6)
...
C
	SOLS=15
        ...
        CALL ARCHIVE(4,INEPH,7)
	DO 227 IPUMP = 1,3
  227   BCO2(IPUMP) = RBCO2(INEPH,7,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,7)
        ENDIF
C
...
C These boundary values are set in KBSET.
	...
	DO 196 ISOL=1,11
	CS(ISOL,1,T)=RCS(1,8,ISOL,1,1)
  196   CS(ISOL,CHOPS(8)+1,T)=RCS(1,8,ISOL,1,1)
	DO 228 IPUMP = 1,3
  228   BCO2(IPUMP) = RBCO2(INEPH,8,IPUMP)
C
        ELSE IF (IFL.EQ.2) THEN
        CALL ARCHIVE(3,INEPH,8)
C These boundary values are set in KBSET.
	PS(1,T)=RPS(INEPH,8,1,1)
	PS(CHOPS(8)+1,T)=RPS(INEPH,8,1,1)
	IMPS(1,T)=RIMPS(INEPH,8,1,1)
	IMPS(CHOPS(8)+1,T)=RIMPS(INEPH,8,1,1)
	DO 206 ISOL=1,11
	CS(ISOL,1,T)=RCS(INEPH,8,ISOL,1,1)
  206   CS(ISOL,CHOPS(8)+1,T)=RCS(INEPH,8,ISOL,1,1)
        ENDIF
C
        SOLS=12
        CHOP=CHOPS(8)
...
C
	...
	AFVM(INEPH) = AFVM0(2)*FVM0(2)*MUM/RMUM(2,1)
	DFVM(INEPH) = DFVM0(2)*FVM0(2)*MUM/RMUM(2,1)
C These boundary values are set in KBSET.
	PS(1,T)=RPS(2,1,1,1)
	PS(CHOPS(1)+1,T)=RPS(2,1,1,1)
	IMPM(1,T)=RIMPM(2,1,1,1)
	...
	CM(ISOL,1,T)=RCM(2,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(2,1,ISOL,1,1)
   66   CS(ISOL,CHOPS(1)+1,T)=RCS(2,1,ISOL,1,1)
	DO 67 ISOL=13,15
	CM(ISOL,1,T)=RCM(2,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(2,1,ISOL,1,1)
   67   CS(ISOL,CHOPS(1)+1,T)=RCS(2,1,ISOL,1,1)
	DO 231 IPUMP = 1,3
  231   BCO2(IPUMP) = RBCO2(INEPH,1,IPUMP)
C
        ELSE IF (IFL.EQ.2) THEN
        CALL ARCHIVE(1,INEPH,1)
	FVM(1,1) = RFVM(INEPH,1,1,1)
	PM(1,1) = RPM(INEPH,1,1,1)
C These boundary values are set in KBSET.
	PS(1,T)=RPS(INEPH,1,1,1)
	PS(CHOPS(1)+1,T)=RPS(INEPH,1,1,1)
	IMPM(1,T)=RIMPM(INEPH,1,1,1)
	IMPS(1,T)=RIMPS(INEPH,1,1,1)
	IMPS(CHOPS(1)+1,T)=RIMPS(INEPH,1,1,1)
	DO 76 ISOL=1,11
	CM(ISOL,1,T)=RCM(INEPH,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(INEPH,1,ISOL,1,1)
   76   CS(ISOL,CHOPS(1)+1,T)=RCS(INEPH,1,ISOL,1,1)
	DO 77 ISOL=13,15
	CM(ISOL,1,T)=RCM(INEPH,1,ISOL,1,1)
	CS(ISOL,1,T)=RCS(INEPH,1,ISOL,1,1)
   77   CS(ISOL,CHOPS(1)+1,T)=RCS(INEPH,1,ISOL,1,1)
C
        ENDIF
        CHOP=CHOPS(1)
...
C
        ...
        CALL ARCHIVE(4,INEPH,2)
	DO 232 IPUMP = 1,3
  232   BCO2(IPUMP) = RBCO2(INEPH,2,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,2)
        ENDIF
C
...
C
        ...
        CALL ARCHIVE(4,INEPH,3)
	DO 233 IPUMP = 1,3
  233   BCO2(IPUMP) = RBCO2(INEPH,3,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,3)
        ENDIF
C
...
C
	SOLS=15
        ...
        MUM=RMUM(INEPH,3)
        CHOP=(INEPH-1)*(CHOPS(4)/5)
        TL=RTL(2,4)*FLOAT(INEPH-1)
        CALL ARCHIVE(4,INEPH,4)
	DO 234 IPUMP = 1,3
  234   BCO2(IPUMP) = RBCO2(INEPH,4,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,4)
        ENDIF
C
...
C
	SOLS=15
        ...
        MUM=RMUM(INEPH,4)
        CHOP=(INEPH-1)*(CHOPS(5)/5)
        TL=RTL(2,5)*FLOAT(INEPH-1)
        CALL ARCHIVE(4,INEPH,5)
	DO 235 IPUMP = 1,3
  235   BCO2(IPUMP) = RBCO2(INEPH,5,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,5)
        ENDIF
C
...
C
	SOLS=15
        ...
        CALL ARCHIVE(4,INEPH,6)
	DO 236 IPUMP = 1,3
  236   BCO2(IPUMP) = RBCO2(INEPH,6,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,6)
        ENDIF
C
...
C
	SOLS=15
        ...
        CALL ARCHIVE(4,INEPH,7)
	DO 237 IPUMP = 1,3
  237   BCO2(IPUMP) = RBCO2(INEPH,7,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,7)
        ENDIF
C
...
C These boundary values are set in KBSET.
	...
	DO 306 ISOL=1,11
	CS(ISOL,1,T)=RCS(1,8,ISOL,1,1)
  306   CS(ISOL,CHOPS(8)+1,T)=RCS(1,8,ISOL,1,1)
	DO 238 IPUMP = 1,3
  238   BCO2(IPUMP) = RBCO2(INEPH,8,IPUMP)
C
        ELSE IF (IFL.EQ.2) THEN 
        CALL ARCHIVE(3,INEPH,8)
C These boundary values are set in KBSET.
	...
	DO 316 ISOL=1,11
	CS(ISOL,1,T)=RCS(INEPH,8,ISOL,1,1)
  316   CS(ISOL,CHOPS(8)+1,T)=RCS(INEPH,8,ISOL,1,1)
        ENDIF
C
        SOLS=12
        CHOP=CHOPS(8)
...
C These boundary values are set in KBSET.
	PS(1,T)=RPS(1,9,1,1)
	PS(CHOPS(9)+1,T)=RPS(1,9,1,1)
	IMPS(1,T)=RIMPS(1,9,1,1)
	IMPS(CHOPS(9)+1,T)=RIMPS(1,9,1,1)
	DO 326 ISOL=1,11
	CS(ISOL,1,T)=RCS(1,9,ISOL,1,1)
  326   CS(ISOL,CHOPS(9)+1,T)=RCS(1,9,ISOL,1,1)
	DO 241 IPUMP = 1,3
  241   BCO2(IPUMP) = RBCO2(INEPH,9,IPUMP)
C
        CHOP=CHOPS(9)
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,10)
	DO 242 IPUMP = 1,3
  242   BCO2(IPUMP) = RBCO2(INEPH,10,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,10)
        ENDIF
C
	SOLS=12
        CHOP=CHOPS(10)
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,11)
	DO 243 IPUMP = 1,3
  243   BCO2(IPUMP) = RBCO2(INEPH,11,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,11)
        ENDIF
C
	SOLS=12
        CHOP=CHOPS(11)
...
C
	SOLS=15
        IF (IFL.EQ.0) THEN
        CALL ARCHIVE(4,INEPH,12)
	DO 244 IPUMP = 1,3
  244   BCO2(IPUMP) = RBCO2(INEPH,12,IPUMP)
        ELSE
        CALL ARCHIVE(3,INEPH,12)
        ENDIF
C
	SOLS=12
        CHOP=CHOPS(12)
