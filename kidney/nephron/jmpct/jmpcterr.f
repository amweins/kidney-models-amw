...
C
	NCELLS=1
C
	QICO2 = BCO2(1)*(AIE(1)*ATIS(1,1,X) + AIS(1)*ATIS(1,1,X))
     1    -BCO2(2)*AMI(1)*ATMI(1,12,X)
C
...
C
	...
	DO 230 K=1,1
	KK=K*(2+SOLS)
	PHI(2+4+KK)=PHI(2+4+KK)+PHI(2+5+KK)+PHI(2+6+KK)-1.D6*QICO2
