...
C
	...
	OPEN (12,FILE='xy.co2')
C
	OPEN (140,FILE='jmpctparam.dat')
	OPEN (141,FILE='jmpctresult.dat')
	OPEN (142,FILE='jmpctbound.dat')
	OPEN (143,FILE='jmpctptpick.dat')
	OPEN (144,FILE='jmpctguess.dat')
	OPEN (145,FILE='jmpctguess.new')
	OPEN (146,FILE='jmpctptim.dat')
	OPEN (147,FILE='jmpctfluxes.dat')
	OPEN (148,FILE='jmpctxy.qo2')
C
