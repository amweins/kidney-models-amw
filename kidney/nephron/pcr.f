...
C
	OPEN (19,FILE='dct/dcparam.tem')
	OPEN (20,FILE='dct/dcparam.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	OPEN (19,FILE='cnt/cnparam.tem')
	OPEN (20,FILE='cnt/cnparam.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C GENERAL PARAMETERS
	DOUBLE PRECISION
     ...
     1   NP(3),KNH4(3),NPHK(3),LHP(3),XIHP(3),XHP(3),NAE1(3)
C
	OPEN (19,FILE='cct/ccparam.tem')
	OPEN (20,FILE='cct/ccparam.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C GENERAL PARAMETERS
	DOUBLE PRECISION
     ...
     1   NP(3),KNH4(3),NPHK(3),LHP(3),XIHP(3),XHP(3),NAE1(3)
C
	OPEN (19,FILE='ompct/omparam.tem')
	OPEN (20,FILE='ompct/omparam.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
