...
C
C
	OPEN (UNIT=22,FILE='imabound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='imaresult.dat')
	OPEN (UNIT=20,FILE='imaparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='imaend.dat')
C
