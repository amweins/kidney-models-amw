...
C
C
	OPEN (UNIT=19,FILE='mrdvr/mrdbound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='mrdvr/mrdbound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF MRDVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
...
C
C
	WRITE (22,150) DT,FVC,HCTC,SAT,
     1  VC,VS(1),VS(2),
     1  PC,PS(1),PS(2),
     1  CC(16),CS(16,1),CS(16,2),
     1  (CC(I),CS(I,1),CS(I,2),I=1,11),
     1  (CC(I),CS(I,1),CS(I,2),I=13,15)
  150   FORMAT (2D12.4,2F8.4,/,3F8.4,/,3F8.4,/,3F8.4,/,(3F14.9))
C
C
...
C
C
	OPEN (UNIT=19,FILE='omdvr/omdbound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='omdvr/omdbound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF OMDVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='imdvr/imdbound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='imdvr/imdbound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF IMDVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='oidvr/oidbound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='oidvr/oidbound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF OIDVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='mravr/mrabound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='mravr/mrabound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF MRAVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='omavr/omabound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='omavr/omabound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF OMAVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='imavr/imabound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='imavr/imabound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF IMAVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
...
C
C
	OPEN (UNIT=19,FILE='oiavr/oiabound.tem',STATUS='old')
	OPEN (UNIT=22,FILE='oiavr/oiabound.dat')
C
C
C  SOLUTE INDEX:
C	1-	NA+
...
C
	PRINT 10
   10   FORMAT(' TYPE THE NUMBER OF OIAVR VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15  PRINT 20, KWR
