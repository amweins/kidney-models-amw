...
C
C
	OPEN (UNIT=22,FILE='omabound.dat',STATUS='old')
	OPEN (UNIT=21,FILE='omaresult.dat')
	OPEN (UNIT=20,FILE='omaparam.dat',STATUS='old')
	OPEN (UNIT=23,FILE='omaend.dat')
C
