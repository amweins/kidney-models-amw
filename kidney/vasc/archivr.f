...
C Plan for 96000 OMAVR, 48000 IMDVR, 24000 MRDVR; AVR are 2x the DVR number
C  OM and IM DVR derive from 12000 JM nephrons; MR DVR from 6000 SF nephrons
...
C        = 2 (INITIALIZE LUMINAL VARIABLES OF THE NEXT SEGMENT)
C        = 3 (RETRIEVE EVERYTHING EXCEPT LUMINAL VARIABLES)
C        = 4 (RETRIEVE INTERSTITIAL VARIABLES)
C
...
C	
C
	GOTO (100,200,300,400,500) IARCH+1
C
  100   CONTINUE
C
...
C
	RETURN
C
C RETRIEVE INTERSTITIAL VARIABLES
C
  500   CONTINUE
C
	DO 520 IX = 1,901
