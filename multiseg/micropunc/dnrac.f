...
C
	WRTIM(3,KXP)= WRTIM(1,KXP)+ WRTIM(2,KXP)
	DO 857 J=1,NWR
  857   WRRES(3,J,KXP)= WRRES(1,J,KXP)+ WRRES(2,J,KXP)
C
  900   CONTINUE
C
...
C
  ...
  903   WRRES(ISEG,4,K)=
	...
	WREX(2,4,K)=WREX(2,2,K)+WREX(2,3,K)-WREX(2,1,K)
C
...
C
	...
	WRITE (2,915) NBARS
	ISEG=0
	WRITE (2,915) ISEG, -WRDL(1,1,K)
	WRITE (2,915) ISEG, WRDL(1,2,K)
	WRITE (2,915) ISEG, WRDL(1,3,K)
	WRITE (2,915) ISEG, WRDL(1,4,K)
	DO 924 ISEG=1,2
	WRITE (2,915) ISEG, WRRES(ISEG,1,K)
	WRITE (2,915) ISEG, -WRRES(ISEG,2,K)
	WRITE (2,915) ISEG, -WRRES(ISEG,3,K)
	WRITE (2,915) ISEG, WRRES(ISEG,4,K)
  924   CONTINUE
	WRITE (2,915) ISEG, -WREX(2,1,K)
	WRITE (2,915) ISEG, WREX(2,2,K)
	WRITE (2,915) ISEG, WREX(2,3,K)
	WRITE (2,915) ISEG, WREX(2,4,K)
  910   CONTINUE
  915   FORMAT (I2,F7.3)
C
	STOP
