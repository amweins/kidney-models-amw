...
C THE CIVAN AND BOOKMAN MODIFICATION TO HMI(1,1)
	HMI(1,1)=HMI11
C
	WRITE (61,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (61,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (61,376)
	DO 375 K=1,1
  375   WRITE (61,378) CELL(K),AIE(K),AI0(K),CLVL0(K),
...
C
C
	WRITE (61,381) PFME,PFES,(PFMI(K),PFIS(K),PFIS(K),K=1,1)
	WRITE (61,384)
	WRITE (61,385) (SOL(I),
	...
	WRITE (61,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,1)
	WRITE (61,390) 1./TGME,1./TGES,
...
C     1  7X,'BSMI',7X,'BSIE',7X,'BSIS')
  385   FORMAT (3X,A5,1X,<2+3*NCELLS>D11.4)
