...
C
	DO 857 J=1,NWR
  857   WRRES(6,J,KXP)= WRRES(1,J,KXP)+ WRRES(2,J,KXP)
C
  900   CONTINUE
C
...
C
  ...
  923   WRITE (2,915) VNAME2(J),
     1    (PRSC*WRDL(ISEG,J,K),ISEG=1,2),PRSC*WREX(2,J,K)
	WRITE (2,904) 
  904   FORMAT(/,2X,'absolute reabsorption',/)
	DO 924 J=1,NWR
  924   WRITE (2,915) VNAME2(J),
     1    (PRSC*WRRES(ISEG,J,K),ISEG=1,2),PRSC*WRRES(6,J,K)
	WRITE (2,905) 
...
C
  930   WRITE (3,917) (PRSC*WRDL(1,J,K),
     1     (PRSC*WRRES(ISEG,J,K),ISEG=1,2),PRSC*WRRES(6,J,K),J=1,NWR)
C
  910   CONTINUE
