...
C
	WRDL(1,4,K)=WRDL(1,2,KXP)+WRDL(1,3,KXP)-WRDL(1,1,KXP)
	DO 903 ISEG=1,2
  903   WRRES(ISEG,4,KXP)=
     1   WRRES(ISEG,1,KXP)-WRRES(ISEG,2,KXP)-WRRES(ISEG,3,KXP)
	WRRES(8,4,KXP)= WRRES(8,1,KXP)-WRRES(8,2,KXP)-WRRES(8,3,KXP)
	WREX(2,4,K)=WREX(2,2,KXP)+WREX(2,3,KXP)-WREX(2,1,KXP)
C
...
C
  ...
  924   CONTINUE
	WRITE (2,915) ISEG, -WREX(2,1,K),0
	WRITE (2,915) ISEG, WREX(2,2,K),1
	WRITE (2,915) ISEG, WREX(2,3,K),2
	WRITE (2,915) ISEG, WREX(2,4,K),3
  910   CONTINUE
