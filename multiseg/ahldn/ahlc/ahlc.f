...
C
C
	OPEN (70,FILE='ahlcparam.dat')
	OPEN (71,FILE='ahlcresult.dat')
	OPEN (72,FILE='ahlcbound.dat')
	OPEN (73,FILE='ahlcptpick.dat')
	OPEN (74,FILE='ahlcguess.dat')
	OPEN (76,FILE='ahlcptim.dat')
	OPEN (77,FILE='ahlcfluxes.dat')
C
