...
C
	...
	DO 903 ISEG=1,NSEG+1
  903   WRRES(ISEG,4,KXP)=
     1   WRRES(ISEG,1,KXP)-WRRES(ISEG,2,KXP)-WRRES(ISEG,3,KXP)
	WREX(NSEG,4,K)=WREX(NSEG,2,KXP)+WREX(NSEG,3,KXP)-WREX(NSEG,1,KXP)
C
...
C
  ...
  924   CONTINUE
	...
	WRITE (2,915) ISEG, WREX(NSEG,2,K),1
	WRITE (2,915) ISEG, WREX(NSEG,3,K),2
	WRITE (2,915) ISEG, WREX(NSEG,4,K),3
  910   CONTINUE
