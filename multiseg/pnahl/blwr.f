	PROGRAM BLWR
C  PROGRAM TO READ THE BLOOD.DAT FILE FROM PN.F
C
...
C
C
	IF(VNAME1.EQ.'vs') GO TO 501
	IF(VNAME1.EQ.'ps') GO TO 502
	IF(VNAME1.EQ.'cs') GO TO 503
	IF(VNAME1.EQ.'phs') GO TO 504
	IF(VNAME1.EQ.'xs') GO TO 505
	IF(VNAME1.EQ.'osms') GO TO 508
C
C
  501   IWR=1
	JWR=2
