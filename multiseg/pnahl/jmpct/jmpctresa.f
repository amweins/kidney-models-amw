...
C
C
	WRITE (141,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (141,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (141,376)
	DO 375 K=1,1
  375   WRITE (141,378) CELL(K),AIE(K),AMI(K),AIS(K),CLVL0(K),
...
C
C
	WRITE (141,381) PFME,PFES,(PFMI(K),PFIE(K),PFIS(K),K=1,1)
	WRITE (141,384)
	WRITE (141,385) (SOL(I),
	...
	WRITE (141,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,1)
	WRITE (141,390) 1./TGME,1./TGES,
