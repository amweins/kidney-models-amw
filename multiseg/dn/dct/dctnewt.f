	SUBROUTINE DCTNEWT(COUNT)
C
	INTEGER SOLS,TAU,T,TLIM,NPAR,X,CHOP,COUNT
C
...
C
 1049   CALL DCTPSET(TAU,TLIM,CHOP)
	READ(62,1050) DT,FVM(X,T),
...
C
	...
	CALL DCTGAM(2,GAMMA)
	X=X+CHOP
C	CLOSE (64,STATUS='KEEP')
C	OPEN (64,FILE='dct/dcguess.new')
C	WRITE (64,1624) (GAMMA(J),J=1,NN)
 1624   FORMAT(D30.20)
C
 9600   RETURN
	END
