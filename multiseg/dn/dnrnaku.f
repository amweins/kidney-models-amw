...
C
	...
	REAL WRRES(6,20,50),RDRES(20),WRDL(6,20,50),DL(20),
     1    WREX(6,20,50),EX(20),TTIM,WRTIM(6,50),SCALE(20)
        CHARACTER*18 IPTFIL,OPTFIL,VARNAM
...
C
	NBARS=7
	WRITE (2,915) NBARS*KXP
	ISEG=0
        DO 902 K=1,KXP
  902   WRITE (2,915) ISEG, WRDL(1,1,K),K-1
	DO 924 ISEG=1,5
        DO 903 K=1,KXP
  903   WRITE (2,915) ISEG, -WRRES(ISEG,1,K),K-1
  924   CONTINUE
        DO 904 K=1,KXP
  904   WRITE (2,915) ISEG, WREX(5,1,K),K-1
C
	WRITE (2,915) NBARS*KXP
	ISEG=0
        DO 905 K=1,KXP
  905   WRITE (2,915) ISEG, WRDL(1,2,K),K-1
	DO 926 ISEG=1,5
        DO 906 K=1,KXP
  906   WRITE (2,915) ISEG, -WRRES(ISEG,2,K),K-1
  926   CONTINUE
        DO 907 K=1,KXP
  907   WRITE (2,915) ISEG, WREX(5,2,K),K-1
C
	WRITE (2,915) NBARS*KXP
	ISEG=0
        DO 912 K=1,KXP
  912   WRITE (2,915) ISEG, WRDL(1,3,K),K-1
	DO 928 ISEG=1,5
        DO 913 K=1,KXP
  913   WRITE (2,915) ISEG, -WRRES(ISEG,3,K),K-1
  928   CONTINUE
        DO 914 K=1,KXP
  914   WRITE (2,915) ISEG, WREX(5,3,K),K-1
C
  910   CONTINUE
