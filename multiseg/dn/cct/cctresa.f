...
C THE STRIETER MODIFICATION TO HMI(1,1), HMI(1,2) AND HME(3)
	...
	HME(3)=HME3
C
	WRITE (41,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (41,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (41,376)
	DO 375 K=1,3
  375   WRITE (41,378) CELL(K),AIE(K),AI0(K),CLVL0(K),
...
C
C
	WRITE (41,381) PFME,PFES,(PFMI(K),PFIS(K),PFIS(K),K=1,3)
	WRITE (41,384)
	WRITE (41,385) (SOL(I),
	...
	WRITE (41,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,3)
	WRITE (41,390) 1./TGME,1./TGES,
