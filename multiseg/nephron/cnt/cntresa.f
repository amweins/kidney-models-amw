...
C
	REAL 
     ...
     1    TGME,TGMI(3),TGIE(3),TGES,TGIS(3),HMI11,HMI12,HME3
C
...
C THE STRIETER MODIFICATION TO HMI(1,1), HMI(1,2) AND HME(3)
	...
	HME(3)=HME3
C
	WRITE (51,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (51,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (51,376)
	DO 375 K=1,3
  375   WRITE (51,378) CELL(K),AIE(K),AI0(K),CLVL0(K),
...
C
C
	WRITE (51,381) PFME,PFES,(PFMI(K),PFIS(K),PFIS(K),K=1,3)
	WRITE (51,384)
	WRITE (51,385) (SOL(I),
     1  SME(I),SES(I),(SMI(K,I),SIS(K,I),SIS(K,I),K=1,3),I=1,SOLS)
	WRITE (51,386)
	WRITE (51,385) (SOL(I),
     1  HAME(I),HAES(I),(HAMI(K,I),HAIE(K,I),HAIS(K,I),K=1,3),I=1,SOLS)
	WRITE (51,388)
	WRITE (51,385) (SOL(I),
     1  GME(I),GES(I),(GMI(K,I),GIE(K,I),GIS(K,I),K=1,3),I=1,SOLS)
	WRITE (51,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,3)
	WRITE (51,390) 1./TGME,1./TGES,
     1  (1./TGMI(K),1./TGIE(K),1./TGIS(K),K=1,3)
C
  381   FORMAT (/,14X,'PFME',7X,'PFES',
     1  7X,'PFMI',7X,'PFIE',7X,'PFIS',
     1  6X,'APFMI',6X,'APFIE',6X,'APFIS',
     1  6X,'BPFMI',6X,'BPFIE',6X,'BPFIS',/,9X,11D11.4)
  384   FORMAT (//,15X,'SME',8X,'SES',
     1  8X,'SMI',8X,'SIE',8X,'SIS',
     1  7X,'ASMI',7X,'ASIE',7X,'ASIS',
     1  7X,'BSMI',7X,'BSIE',7X,'BSIS')
  385   FORMAT (3X,A5,1X,11D11.4)
  386   FORMAT (//,15X,'HME',8X,'HES',
     1  8X,'HMI',8X,'HIE',8X,'HIS',
     1  7X,'AHMI',7X,'AHIE',7X,'AHIS',
     1  7X,'BHMI',7X,'BHIE',7X,'BHIS')
  388   FORMAT (//,15X,'GME',8X,'GES',
     1  8X,'GMI',8X,'GIE',8X,'GIS',
     1  7X,'AGMI',7X,'AGIE',7X,'AGIS',
     1  7X,'BGMI',7X,'BGIE',7X,'BGIS')
