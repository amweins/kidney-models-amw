...
C
	WRITE (10,400) (SOL(I),I=1,11),(SOL(I),I=13,16)
...
C
	WRITE (10,430) (SOL(I),I=1,11),(SOL(I),I=13,15),SOL(12)
...
C
	WRITE (10,460) (SOL(I),I=1,11),(SOL(I),I=13,17)
  ...
  470   WRITE (10,480) DIST,OSMM(KX),
     1  1.D3*FVM(KX,T),(1.D3*FKM(I,KX,T),I=1,11),
     1  (1.D3*FKM(I,KX,T),I=13,16),1.D3*FVM(KX,T)*TA(KX)
  480   FORMAT (F7.4,6F9.6,D9.3,4F9.6,
     1   D9.3,2F9.6,D9.3,3F9.6)
C
	DO 520 KX=X-CHOP,X
	OSMS(KX)=IMPS(KX,T)
	DO 520 I=1,SOLS
...
C
	WRITE (11,600) (SOL(I),I=1,11),(SOL(I),I=13,16)
...
C
C	WRITE (23,570) PM(1,1),60.D6*FVM(1,1),60.D6*FVM(CHOP+1,1),
C     1     (1.0 - FVM(CHOP+1,1)/FVM(1,1)),FVM(1,1)/AM(1,1)
  570   FORMAT (8E16.8)
	RETURN
	END
