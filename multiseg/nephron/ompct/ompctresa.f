...
C THE STRIETER MODIFICATION TO HMI(1,1), HMI(1,2) AND HME(3)
	...
	HME(3)=HME3
C
	WRITE (31,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (31,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (31,376)
	DO 375 K=1,2
  375   WRITE (31,378) CELL(K),AIE(K),AI0(K),CLVL0(K),
...
C
C
	WRITE (31,381) PFME,PFES,(PFMI(K),PFIE(K),PFIS(K),K=1,2)
	WRITE (31,384)
	WRITE (31,385) (SOL(I),
     1  SME(I),SES(I),(SMI(K,I),SIS(K,I),SIS(K,I),K=1,2),I=1,SOLS)
	WRITE (31,386)
	WRITE (31,385) (SOL(I),
     1  HAME(I),HAES(I),(HAMI(K,I),HAIE(K,I),HAIS(K,I),K=1,2),I=1,SOLS)
	WRITE (31,388)
	WRITE (31,385) (SOL(I),
     1  GME(I),GES(I),(GMI(K,I),GIE(K,I),GIS(K,I),K=1,2),I=1,SOLS)
	WRITE (31,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,2)
	WRITE (31,390) 1./TGME,1./TGES,
     1  (1./TGMI(K),1./TGIE(K),1./TGIS(K),K=1,2)
C
  ...
  389   FORMAT (/,3X,'TOTAL',1X,8D11.4)
  390   FORMAT (/,3X,'RESIS',1X,8D11.4)
C
C
 	RETURN
	END
