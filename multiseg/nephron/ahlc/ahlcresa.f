...
C
C
	WRITE (71,372) RTE,F,PKC,PKP,PKN,KHY(4),KDHY(4)
	WRITE (71,374) L0,AME,AE0,MUA,CHVL0,MUV
	WRITE (71,376)
	DO 375 K=1,1
  375   WRITE (71,378) CELL(K),AIE(K),AI0(K),CLVL0(K),
...
C
C
	WRITE (71,381) PFME,PFES,(PFMI(K),PFIS(K),PFIS(K),K=1,1)
	WRITE (71,384)
	WRITE (71,385) (SOL(I),
	...
	WRITE (71,389) TGME,TGES,(TGMI(K),TGIE(K),TGIS(K),K=1,1)
	WRITE (71,390) 1./TGME,1./TGES,
