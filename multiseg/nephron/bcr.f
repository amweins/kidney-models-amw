	PROGRAM BCR
C TO INVOKE ALL OF THE SUBDIRECTORY BCR PROGRAMS
C
	INTEGER TLIM
C
	PRINT 60
...
C
C
	OPEN (19,FILE='sfpct/sfpctbound.tem')
	OPEN (22,FILE='sfpct/sfpctbound.dat')
C
	SOLS=15
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF SFPCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
...
C
C
	OPEN (19,FILE='sfpst/sfpstbound.tem')
	OPEN (22,FILE='sfpst/sfpstbound.dat')
C
	SOLS=15
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF SFPST VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='jmpct/jmpctbound.tem')
	OPEN (22,FILE='jmpct/jmpctbound.dat')
C
	SOLS=15
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF JMPCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='jmpst/jmpstbound.tem')
	OPEN (22,FILE='jmpst/jmpstbound.dat')
C
	SOLS=15
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF JMPST VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='sdhl/sdhlbound.tem')
	OPEN (22,FILE='sdhl/sdhlbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF SDHL VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='ldhlu/ldhlubound.tem')
	OPEN (22,FILE='ldhlu/ldhlubound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF LDHLU VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='ldhll/ldhllbound.tem')
	OPEN (22,FILE='ldhll/ldhllbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF LDHLL VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='tahl/tahlbound.tem')
	OPEN (22,FILE='tahl/tahlbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF TAHL VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='ahlm/ahlmbound.tem')
	OPEN (22,FILE='ahlm/ahlmbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF AHLM VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='ahlc/ahlcbound.tem')
	OPEN (22,FILE='ahlc/ahlcbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF AHLC VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='dct/dcbound.tem')
	OPEN (22,FILE='dct/dcbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF DCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='cnt/cnbound.tem')
	OPEN (22,FILE='cnt/cnbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF CNT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='cct/ccbound.tem')
	OPEN (22,FILE='cct/ccbound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF CCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
C
	OPEN (19,FILE='ompct/ombound.tem')
	OPEN (22,FILE='ompct/ombound.dat')
C
	SOLS=12
C
C  SOLUTE INDEX:
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF OMPCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
...
C
	PRINT 10
   10   FORMAT(' PRINT THE NUMBER OF IMCT VARIABLES TO BE INCREMENTED')
	READ *, NWR
	IF(NWR.EQ.0) GO TO 801
	DO 800 KWR=1,NWR
   15   PRINT 20, KWR
