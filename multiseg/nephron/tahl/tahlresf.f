...
C
  ...
  300   FORMAT(//,1X,'DIST',2X,'Na:',3X,'FLUX',6X,'FEKM',6X,'FIKM')
	...
	DO 310 KX=X-CHOP,X
	DIST=DIST+DX
  310   WRITE (97,320) DIST,FLUXS(1,KX),FEKM(1,KX,T),FIKM(1,1,KX,T)
...
C
  ...
  330   FORMAT(//,1X,'DIST',2X,'K:',5X,'FLUX',6X,'FEKM',6X,'FIKM')
	...
	DO 340 KX=X-CHOP,X
	DIST=DIST+DX
  340   WRITE (97,350) DIST,FLUXS(2,KX),FEKM(2,KX,T),FIKM(1,2,KX,T)
...
C
  ...
  360   FORMAT(//,1X,'DIST',2X,'Cl:',3X,'FLUX',6X,'FEKM',6X,'FIKM')
	...
	DO 370 KX=X-CHOP,X
	DIST=DIST+DX
  370   WRITE (97,380) DIST,FLUXS(3,KX),FEKM(3,KX,T),FIKM(1,3,KX,T)
...
C
  ...
  390   FORMAT(//,1X,'DIST',2X,'NH4:',3X,'FLUX',6X,'FEKM',6X,'FIKM',
	...
	DO 400 KX=X-CHOP,X
	DIST=DIST+DX
  400   WRITE (97,410) DIST,FLUXS(11,KX),FEKM(11,KX,T),FIKM(1,11,KX,T),
     1  FIKM(1,10,X,T)
