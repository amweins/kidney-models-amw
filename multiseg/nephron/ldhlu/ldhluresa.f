...
C
C
	WRITE (111,372) RTE,F,PKC,PKP,PKN,KHY(5),KDHY(5)
	WRITE (111,374) AME,AI0(1)
C
...
C
  ...
  380   FORMAT (//)
C
	WRITE (111,381) PFME,(PFMI(K),K=1,1)
	WRITE (111,384)
	WRITE (111,385) (SOL(I),SME(I),(SMI(K,I),K=1,1),I=1,SOLS)
	WRITE (111,386)
	WRITE (111,385) (SOL(I),HAME(I),(HAMI(K,I),K=1,1),I=1,SOLS)
	WRITE (111,388)
	WRITE (111,385) (SOL(I),GME(I),(GMI(K,I),K=1,1),I=1,SOLS)
	WRITE (111,389) TGME,(TGMI(K),K=1,1)
	WRITE (111,390) 1./TGME,(1./TGMI(K),K=1,1)
C
